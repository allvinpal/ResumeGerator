...
import {
  FileText, Save, Eye, EyeOff, Download, Menu, X,
} from 'lucide-react';
...
export default function BuilderPage() {
  ...
  // Load sample resume if empty (for demo purposes)
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="h-screen flex flex-col no-print">
        {/* Builder Header */}
        <header className="h-14 bg-white border-b border-secondary-200 flex items-center justify-between px-4 flex-shrink-0">
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <aside
            className={`
              w-[260px] flex-shrink-0 builder-sidebar
          ...
          <div
            className={`
              flex-1 builder-form overflow-y-auto
        ...
        <div className="lg:hidden flex-shrink-0 bg-white border-t border-secondary-200 px-4 py-2 flex gap-2">
          <Button variant="outline" size="sm" icon={<Save size={14} />} fullWidth>
            Save
          </Button>
          <Button size="sm" icon={<Download size={14} />} fullWidth>
            PDF
          </Button>
          <Button variant="secondary" size="sm" icon={<Download size={14} />} fullWidth>
            DOCX
          </Button>
        </div>
      </div>
