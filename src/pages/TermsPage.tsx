...
export default function TermsPage() {
  return (
    <>
      <Helmet>
        <title>Terms of Use — CVMint</title>
        <meta name="description" content="CVMint terms of use. Free resume builder with no guarantees of employment outcomes." />
      </Helmet>
        ...
        <div className="prose prose-secondary max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-secondary-600">
              CVMint provides free online tools for creating, editing, and exporting professional resumes.
          ...
          <section>
            ...
            <p className="text-secondary-600">
              You retain full ownership of all resume content you create using CVMint.
          ...
          <section>
            ...
            <p className="text-secondary-600">
              ATS compatibility scores provided by CVMint are estimates based on keyword matching and
          ...
          <section>
            ...
            <p className="text-secondary-600">
              CVMint is a resume-building tool. We do not guarantee any employment outcomes, interviews,
          ...
          <section>
            ...
            <p className="text-secondary-600">
              The core features of CVMint — resume creation, template selection, PDF export, and DOCX
